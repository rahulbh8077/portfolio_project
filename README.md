...
[![Vite Engine](https://img.shields.io/badge/Vite-646CFF?style=for-the-badge&logo=vite&logoColor=white)](https://vitejs.dev)
[![Tailwind CSS](https://img.shields.io/badge/Tailwind_CSS-38B2AC?style=for-the-badge&logo=tailwind-css&logoColor=white)](https://tailwindcss.com)
[![GSAP Animations](https://img.shields.io/badge/GSAP-88CE02?style=for-the-badge&logo=greensock&logoColor=white)](https://greensock.com)
[![Resend Email](https://img.shields.io/badge/Resend_API-000000?style=for-the-badge&logo=email&logoColor=white)](https://resend.com)
...
| :---: | :---: | :---: | :---: |
| ![Visitor Badge](https://page-views.glitch.me/badge?page_id=rahulbh8077.portfolio) | [![Followers](https://img.shields.io/github/followers/rahulbh8077?style=social)](https://github.com/rahulbh8077) | [![Stars](https://img.shields.io/github/stars/rahulbh8077?style=social)](https://github.com/rahulbh8077) | ![Views](https://komarev.com/normalise-svg.png?connection=rahulbh8077-portfolio&color=blue) |
...
The Structural architecture is given below as follows:
The following structural mapping represents the frontend routing layout and component tree hierarchy.

```mermaid
graph TD
    Root[index.html ROOT] --> Header[Sticky Navigation Bar]
    Root --> Hero[00. Hero Section]
    Root --> About[01. About Me]
    Root --> Skills[02. Skills Directory]
    Root --> Projects[03. Project Showcase]
    Root --> Milestones[04. Milestones - Experience]
    Root --> Certs[05. Accreditations]
    Root --> Journey[06. Learning Roadmap]
    Root --> Tech[07. Tech Stack Grid]
    Root --> Resume[08. Curriculum Vitae]
    Root --> Contact[09. Get In Touch Form]
    Root --> Social[10. Social Grid]
    Root --> Footer[11. Footer Section]
    
    style Root fill:#000000,stroke:#ffffff,stroke-width:2px,color:#ffffff
    style Tech fill:#111111,stroke:#ffffff,stroke-width:1px,color:#ffffff
```
...
flowchart TD
    ...
    Research --> Wireframe[Layout Planning & Wireframing]
    Wireframe --> Design[Theme Tokens & CSS variables]
    Design --> Dev[HTML Markup & JS Scripting]
    Dev --> Test[Cross-browser & Mobile verification]
    Test --> Optimize[SEO tagging & Asset minification]
    Optimize --> Deploy[Vercel Serverless Function Config]
...
```mermaid
flowchart TD
    Visitor[User visits Portfolio] --> ViewHero[Hero Section & Bio]
    ViewHero --> Nav[Uses Navigation Links]
    Nav --> ViewProjects[Inspects Projects Showcase]
    Nav --> ViewSkills[Inspects Skills Directory]
    Nav --> Contact[Fills Contact Form]
    Contact --> Submit{Validate Inputs?}
    Submit -->|No| Alert[Show Warning Message]
    Submit -->|Yes| Fetch[Fetch POST API Route]
    Fetch --> API[Vercel Contact Serverless Function]
    API --> ResendAPI[Resend Mail Service API]
    ResendAPI --> Success[Success Alert / Send Email to rahulbh8077@gmail.com]
```
...
timeline
    ...
    Phase 1 - Frontend : HTML5 : CSS3 : JavaScript : Responsive UI
    Phase 2 - Analytics & Databases : Python : SQL : NumPy : Pandas : Matplotlib : MySQL
    Phase 3 - Machine Learning : Scikit-Learn : Regression : Clustering : Tree Models
    Phase 4 - Deep Learning : TensorFlow : PyTorch : OpenCV : HuggingFace
    Phase 5 - Generative AI : OpenAI API : LangChain : Vector Databases : Agentic Workflows
```
...
gitGraph
    ...
    commit id: "Setup boilerplate layout"
    branch develop
    checkout develop
    commit id: "Feature: Skills Radars"
    branch feature/tech-stack
    checkout feature/tech-stack
    commit id: "Build: Category cards"
    commit id: "Fix: SVG size attributes"
    checkout develop
    merge feature/tech-stack
    commit id: "Add: Serverless contact mail"
    checkout main
...
| :---: | :---: |
| ![Desktop View](https://via.placeholder.com/800x450/050505/ffffff?text=Portfolio+Desktop+View) | ![Mobile View](https://via.placeholder.com/300x500/050505/ffffff?text=Portfolio+Mobile+View) |
...
```mermaid
flowchart TD
    Fork[Fork Repository] --> Clone[Clone Local]
    Clone --> Branch[Create Feature Branch]
    Branch --> Code[Write Codes / Features]
    Code --> Push[Push to Fork]
